...
def get_user_inventory(title_id):
    url = f"https://{title_id}.playfabapi.com/Client/GetUserInventory"
    headers = {
    ...
    if response.status_code != 200:
        ...
        print(catalog)
        filename = f"output/playfabstuff/etxnight-playfab-output/inventory/{title_id}_inventory.json"
